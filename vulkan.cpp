...
bool Vulkan::isDeviceSuitable(VkPhysicalDevice device) {
  ...
  pageableDeviceLocalMemoryFeatures.sType =
  ...
  bool allFeaturesSupported =
      ...
      pageableDeviceLocalMemoryFeatures.pageableDeviceLocalMemory;
...
VkSurfaceFormatKHR Vulkan::chooseSwapSurfaceFormat(
  ...
  if (auto it =
          std::find_if(begin(availableFormats), end(availableFormats), is_best);
...
uint32_t Vulkan::findMemoryType(uint32_t typeFilter,
...
void Vulkan::createTextureImage() {
  ...
  createImage(texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB,
              ...
              textureImageMemory, mipLevels, VK_SAMPLE_COUNT_1_BIT);
...
void Vulkan::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width,
                               uint32_t height) {
  VkCommandBuffer commandBuffer = beginSingleTimeCommands(transferCommandPool);
...
void Vulkan::generateMipmaps(VkImage image, int32_t texWidth, int32_t texHeight,
